...
var ReactDrawer = function (_React$Component) {
  ...
  _createClass(ReactDrawer, [{
    ...
    value: function getDrawerClassName(theme, animate) {
      ...
      var slide = animate['slide' + direction + start];
      return (0, _classnames2.default)('react-drawer-drawer', theme.drawer, drawerTheme, animate.animated, slide, _defineProperty({}, '' + theme.hidden, this.state.hiddenDrawer));
    }
  }, {
    key: 'render',
